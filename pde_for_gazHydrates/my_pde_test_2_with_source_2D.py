...
grid = CartesianGrid([[0, x_length], [0, y_length]], [N_x, N_y])  # generate grid
#grid = UnitGrid([16, 16, 16])
Pres = 200 * 10**5
p0 = np.ones((N_x, N_y))*Pres # начальное пластовое давление случайное

#bc = {'value': Pres}
bc_x_left = {"value": 200*10**5}
bc_x_right = {"value": 500*10**5}
...
result = eq.solve(field, t_range=60*60, dt = delta_t)
