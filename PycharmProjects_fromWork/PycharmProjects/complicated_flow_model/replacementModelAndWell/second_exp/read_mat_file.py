...
print(pressure_dict['Pini'].transpose())

points_coords_dict = {0:[57, -127], 1:[70, 0], 2:[-57,127], 3: [0, 127], 4: [121,	-121], 5: [65, 65], 6: [-127, 0],
7: [0, 70], 8: [-185,	0], 9: [127, 0], 10: [0, -70], 11:[0, 0], 12:[-121, -121], 13:[121, 121]}
