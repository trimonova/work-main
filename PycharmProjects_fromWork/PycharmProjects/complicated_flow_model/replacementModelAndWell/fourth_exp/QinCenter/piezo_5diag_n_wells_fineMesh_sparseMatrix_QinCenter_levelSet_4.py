...
def total_piezo_task(N_r_full, M_fi_full, Pres_distrib, c3_oil, c3_water, CP_dict, q_coef, wells_coord, delta_r_list, delta_fi_list, porosity, C_total, perm, delta_t,
                         r_well, coord_matrix_cart, coord_matrix_rad, mu_oil, mu_water, q, t):
    r_bound_init = 0.005
    bound_coords = []
    for fi in range(360):
