...
def replace_boundary(frac_angle_1, frac_angle_2, oval_width, frac_length_1, frac_length_2, M_fi_full, N_r_full, coord_matrix):
    ...
    # u_1 = 0
    # v_1 = 0
    oval_length_1 = frac_length_1 + 0.001
    ...
    # u_2 = 0
    # v_2 = 0
    oval_length_2 = frac_length_2 + 0.001
